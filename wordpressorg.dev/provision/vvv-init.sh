...
if [ ! -d $SITE_DIR ]; then
	...
	wget https://downloads.wordpress.org/translation/core/4.2/ja.zip -O $SITE_DIR/wp-content/languages/ja.zip
	unzip $SITE_DIR/wp-content/languages/ja.zip -d $SITE_DIR/wp-content/languages/
	rm -f $SITE_DIR/wp-content/languages/ja.zip

	wget https://downloads.wordpress.org/translation/core/4.2/es_ES.zip -O $SITE_DIR/wp-content/languages/es_ES.zip
